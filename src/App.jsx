        ...
        {!logado ? (
          <div className="login-box">
            <div className="login-header">
              {/* Removido o botão de voltar */}
              <h1>
                Painel de<br />Transferência
              </h1>
            </div>
            <div className="input-group">
              <div className="select-wrapper">
                <span className="select-icon">
                  <svg width="20" height="20" viewBox="0 0 20 20">
                    ...
                    <path d="M3 17c0-2.8 3.7-4.5 7-4.5s7 1.7 7 4.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                  </svg>
                </span>
                <select
              ...
              <div className="input-wrapper">
                <span className="input-icon">
                  <svg width="20" height="20" viewBox="0 0 20 20">
                    <rect x="5" y="9" width="10" height="7" rx="2.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                    <path d="M10 9V6a2.5 2.5 0 1 0-5 0v3" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                  </svg>
                </span>
                <input
                  type="password"
